...
export function Footer() {
  return (
    <footer className="bg-[#0A0E14] border-t border-white/[0.06] pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-white/[0.06]">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm text-[#A8B0BA] leading-relaxed mb-5">
            ...
            <div className="flex items-center gap-3">
              {['IG', 'TW', 'FB', 'YT'].map((label, i) => (
                <a key={i} href="#" className="w-9 h-9 rounded-full bg-white/5 hover:bg-[#F4B942]/20 border border-white/10 hover:border-[#F4B942]/30 flex items-center justify-center text-[#A8B0BA] hover:text-[#F4B942] transition-all text-[10px] font-bold">
                  {label}
                </a>
              ))}
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-[#A8B0BA]">
              {[
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-[#A8B0BA]">
            ...
            <div className="mt-5">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 bg-white/5 border border-white/10 rounded-lg px-3 py-2 text-xs text-white placeholder:text-[#A8B0BA]/60 focus:outline-none focus:border-[#F4B942]/40 transition-all"
                />
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-[#A8B0BA]/60">
