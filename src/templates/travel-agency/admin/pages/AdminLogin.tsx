    ...
    <div className="min-h-screen bg-[#FDFAF5] flex items-center justify-center px-4">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-[#78716C] text-sm mt-1">Access the travel management console</p>
        </div>
        ...
        <div className="bg-white border border-[#E8E0D5] rounded-2xl p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="text-xs text-[#78716C] mb-1.5 block">Admin Email</label>
          ...
          <div className="mt-5 pt-5 border-t border-[#E8E0D5]">
            <p className="text-xs text-[#78716C] text-center mb-2">Demo Credentials</p>
